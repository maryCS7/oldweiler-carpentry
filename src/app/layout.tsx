  ...
  return (
    <html lang="en">
      ...
      <body className="bg-[var(--color-background)] text-[var(--color-foreground)] font-sans antialiased">
        ...
        <a
          href="/"
          className="fixed bottom-6 right-6 bg-[var(--accent-blue)] text-white p-4 rounded-full shadow-lg hover:bg-[var(--accent-blue-hover)] transition-all duration-200 hover:scale-110 z-50"
          title="Back to Home"
        >
