...
export const projects = [
  ...
  },
  {
    ...
    description: "Custom kitchen remodel with light blue cabinetry, wooden butcher block island countertop, and modern appliances.",
  ...
  },
  {
    ...
    description: "Custom elevated deck featuring a privacy wall and staircase with railing, built against a house with gravel base.",
  ...
  },
  {
    ...
    description: "Custom light gray composite bench with wooden frame, positioned on a matching composite deck with rustic wooden fence backdrop.",
    tags: ["bench", "deck", "composite", "outdoor"],
    galleryImage: "/gallery/project19.JPG",
  },
  {
    slug: "additional-custom-project",
    title: "Additional Custom Project",
    description: "Another example of our custom carpentry work showcasing quality craftsmanship and attention to detail.",
